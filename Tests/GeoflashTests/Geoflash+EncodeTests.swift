...
final class GeoflashEncodeTests: XCTestCase {
    ...
    func testOutOfRangeEncoding() {
        ...
        for _ in 0..<1_000 {
            ...
            XCTAssertThrowsError(try Geoflash
                .encode(latitude: invalidLatitude,
    ...
    func testKnownExamplePrecision() throws {
        ...
        try [
            ...
            let talca = try Geoflash
                .encode(latitude: talcaLatitude,
                        longitude: talcaLongitude,
                        precision: test.precision)
            
            let points = try Geoflash
                .decode(geohash: talca)
